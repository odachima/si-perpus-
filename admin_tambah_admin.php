...
?>
    <br>
	<br>
	<h1 class="display-6 text-center">Halaman Daftar Admin (Admin)</h1>
	<br>
	<div class="row">
		<div class="col-md-12 mx-auto">
			<div class="card">
				<h3 class="card-header ms-2 bg-light"><b>Data Admin (Admin)</b></h3>
				<div class="card-body col-md-6 mx-auto">
					<table border="1" class="table">
						...
						$query_mysql = mysqli_query($koneksi, "SELECT * From datauser where akses_id = 1") or die(mysql_error());
						$nomor = 1;
			...
			<div class="card">
				...
				<div class="card-body ">
					...
					<form action="input-aksi_akun.php" method="post" class="row g-3 mx-auto">
						...
						<div>
							<input type="hidden" name="akses_id" value="1" class="form-control">
						</div>
						<div>
